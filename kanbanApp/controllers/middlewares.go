...
func SetUserRole(c *gin.Context) {
	...
	for i := 0; ; i++ {
		...
		var user models.User //buradaki userIDStr, formdan alınan useridlre,bunlar da for ile alındı
		...
		var whouser models.User //whouser dediğimiz kişi buradaki oturumda olan ve işlemi gerçekleştiren kişi
