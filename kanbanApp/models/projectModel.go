...
type Project struct {
	...
	//	Assignee    []User    `gorm:"many2many:issue_assignees"`
}
...
func (project Project) Migrate() {
	...
	db.AutoMigrate(&project) //This block creates a table with this name on the database.
...
func GetProjects(c *gin.Context) {
	...
	msg := projects[21].Issues[0].ID //console log
	fmt.Println(msg)                 //console log
}
...
// eklenen kullanıcıların projeyi görebilmesi için
